...
export function MZFlag(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      <g clipPath="url(#mz-a)" transform="scale(.9375)">
        ...
        <path fill="#000001" fillRule="evenodd" d="M0 176h768v160H0z" />
        <path fill="#fff" fillRule="evenodd" d="M0 336h768v16H0z" />
        <path fill="#ffca00" fillRule="evenodd" d="M0 352h768v160H0z" />
        <path fill="red" fillRule="evenodd" d="M0 0v512l336-256z" />
        <path
          fill="#ffca00"
          fillRule="evenodd"

...
export function EACFlag(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      <g transform="translate(41.1 674.6)scale(.87273)">
        ...
        <path
          ...
          fontSize="18"
          fontWeight="400"
          style={{ lineHeight: "125%", textAlign: "start" }}
        ...
        />
        <g fillRule="evenodd" stroke="#000" strokeWidth=".4">
          <path
            fill="#0087ff"

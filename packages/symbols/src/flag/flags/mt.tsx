...
export function MTFlag(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      >
        ...
        <circle r="3200" />
        <circle r="2368" />
        <g id="mt-a" strokeLinejoin="round" strokeWidth="48">
        ...
        <use xlinkHref="#mt-a" transform="rotate(90)" />
        <use xlinkHref="#mt-a" transform="scale(-1)" />
        <use xlinkHref="#mt-a" transform="rotate(-90)" />
      </g>
      ...
      <g
        ...
        strokeWidth="36"
      >
        <path strokeWidth=".7" d="M137.9 185.8a588 588 0 0 1 48 0" />
        <path
          strokeWidth=".4"
          d="m160 143.3 1.3 1.5m2 19.2q-.1 2 .2 3.2m-3.2-3c.4.5 1 2.3 1 3"
        />
        <path
          fill="#fff"
          strokeWidth=".5"
        ...
        />
        <path strokeWidth=".4" d="m166.7 135 9.5 5" />
        <g strokeWidth=".3">
          <path
            fill="#fff"
        ...
        />
        <path strokeWidth=".1" d="m149.8 160.6-7.6-7.6" />
        <path
          fill="#fff"
          strokeWidth=".5"

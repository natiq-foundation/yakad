...
export function KYFlag(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      >
        <use xlinkHref="#ky-a" width="100%" height="100%" />
        <use xlinkHref="#ky-b" width="100%" height="100%" />
        <use xlinkHref="#ky-c" width="100%" height="100%" />
        <use xlinkHref="#ky-d" width="100%" height="100%" />
        <use xlinkHref="#ky-e" width="100%" height="100%" />
        <use xlinkHref="#ky-f" width="100%" height="100%" />
        <use xlinkHref="#ky-g" width="100%" height="100%" />
      </g>
      <g
        stroke="#000"
        strokeWidth="1.4"
      ...
      <g strokeWidth="1.4" transform="translate(-306.8 -21.2)scale(.87136)">
        ...
        <use xlinkHref="#ky-h" width="100%" height="100%" x="90.1" />
        <use xlinkHref="#ky-h" width="100%" height="100%" x="45" y="52.2" />
        <path
          fill="none"
          stroke="#000"
          d="M989.7 233v93.4c0 81-38.3 108.8-89.6 130.8-51.3-22-90-49.8-90-130.8v-93.5h179.6z"
